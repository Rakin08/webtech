<?php
    ...
    $name = $pn = $email =$un=$gender=$pass=$Cpass=$dob="";
    
    $UploadConfirmation = "";
    $target_file="";

    
    $nameErr =$pnErr=$emailErr=$unErr=$genderErr=$passErr=$CpassErr=$dobErr=$pictureErr=$ImgErr="";
    ...
    $dob = test_input($_POST["dob"]);
       ...
       $insertion = "";
   if($nameErr =="" && $pnErr=="" && $emailErr==""&&$unErr==""&&$genderErr==""&&$passErr==""&&$CpassErr==""&&$dobErr==""&&$ImgErr=="")
     {
